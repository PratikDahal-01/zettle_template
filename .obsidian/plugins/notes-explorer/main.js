...
var DEFAULT_SETTINGS = {
  ...
  tagPositionForCardColor: "content" /* content */,
  pinnedFiles: [],
  tagColors: [],
...
var NotesExplorerSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Launch on start").setDesc("Open the notes explorer board when Obsidian starts").addToggle(
    ...
    new import_obsidian.Setting(containerEl).setName("Page view mode").setDesc(
    ...
    const cardsPerPageSetting = new import_obsidian.Setting(containerEl).setName("Cards per page").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Click mode").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Open note layout").setDesc("Select how should the parent note be opened from the card.").addDropdown(
      (dropdown) => dropdown.addOptions({
        ["right" /* Right */]: "Open note on right side",
        ["tab" /* NewTab */]: "Open note in new tab",
        ["sameTab" /* SameTab */]: "Open note in same tab",
    ...
    new import_obsidian.Setting(containerEl).setName("Deleted files").setDesc("What happens to a file after you delete it.").addDropdown(
      (dropdown) => dropdown.addOptions({
    ...
    new import_obsidian.Setting(containerEl).setName("Note's content interactions").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Open board on folder click").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Cards ui").setHeading();
    new import_obsidian.Setting(containerEl).setName("Title display mode").setDesc("Select what you want to see at the top of each card.").addDropdown(
      (dropdown) => dropdown.addOptions({
    ...
    new import_obsidian.Setting(containerEl).setName("Fixed card height").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Maximum number of lines").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Show delete button").setDesc("Disable this option to remove the delete button.").addToggle(
    ...
    new import_obsidian.Setting(containerEl).setName("Note's metadata").setDesc(
    ...
    const frontmatterTagSetting = new import_obsidian.Setting(containerEl).setName("Frontmatter tag").setDesc("Enter the name of the frontmatter tag to display its value.").addText(
    ...
    new import_obsidian.Setting(containerEl).setName("Footer always visible").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Tag color indicator").setHeading();
    new import_obsidian.Setting(containerEl).setName("Which tags to read").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Indicator type").setDesc(
    ...
    const renderCardColorsSettings = () => {
      ...
      this.plugin.settings.tagColors.sort((a, b) => a.order - b.order).forEach((tag, index2) => {
        ...
        let rgbaInput;
        new import_obsidian.Setting(row).setClass("notes-explorer-tag-container-tag-row-element").addButton(
    ...
    new import_obsidian.Setting(containerEl).setName("Exclude folders").setHeading();
    new import_obsidian.Setting(containerEl).setName("Folder name").setDesc(
      ...
      (text2) => text2.setPlaceholder("Enter folder path").onChange((value) => {
        this.tempFolderName = value;
      })
    ).addButton(
      (button) => button.setButtonText("Add").setCta().onClick(() => {
        const folderInput = (0, import_obsidian.normalizePath)(this.tempFolderName);
    ...
    const folderIcon = (element2) => (0, import_obsidian.setIcon)(element2, "folder");
...
var allAllowedFiles = derived(
  ...
  ([$settings, $refreshSignal, $folderName]) => {
    ...
    if ($folderName === "") {
      ...
      const folder = get_store_value(app).vault.getAbstractFileByPath($folderName);
    ...
    const filteredFiles2 = allFiles.filter((file) => {
...
var sortedFiles = derived(
  [sort2, files, settings],
  ([$sort, $files, $settings]) => {
    const isPinned = (path) => $settings.pinnedFiles.includes(path);
    ...
    Promise.all(
      ...
      set(
        $sortedFiles.filter((file, index2) => {
          const [contentMatch, nameMatch, tagsMatch] = searchResults[index2];
...
var isEmptyFile = async (file) => {
  ...
  const contentWfrontmatter = content.replace(`---
${frontMatter}
---`, "").trim().length;
...
var tags = derived(
  ...
  ([$allAllowedFiles, $appCache]) => {
    const tags2 = $allAllowedFiles.map(
...
function hookMarkdownLinkMouseEventHandlers(app2, plugin2, containerEl, sourcePath, filePath) {
    ...
    plugin2.registerDomEvent(el, "click", (evt) => {
      ...
      if (linktext) {
        app2.workspace.openLinkText(
          linktext,
          sourcePath,
          import_obsidian4.Keymap.isModEvent(evt)
        );
      }
    });
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      t3 = space();
      div1 = element("div");
      div1.textContent = `${/*getFooterMetadata*/
      ctx[20]()}`;
      t5 = space();
      if_block3.c();
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, plugin, ($$value) => $$invalidate(26, $plugin = $$value));
  ...
  let pinned;
  let backgroundColor = "";
  const pinButton = (element2) => (0, import_obsidian5.setIcon)(element2, "pin");
  const trashIcon = (element2) => (0, import_obsidian5.setIcon)(element2, "trash");
  const folderIcon = (element2) => (0, import_obsidian5.setIcon)(element2, "folder");
  const blankIcon = (element2) => (0, import_obsidian5.setIcon)(element2, "blank");
  const vaultIcon = (element2) => (0, import_obsidian5.setIcon)(element2, "vault");
  const pinnedIcon = (element2) => (0, import_obsidian5.setIcon)(element2, "circle-stop");
  ...
  const renderNoteCard = (el) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (content.trim().length > 0) {
      ...
      yield import_obsidian5.MarkdownRenderer.render($app, truncatedContent, el, file.path, $view);
      postProcessRenderedContent(el);
      if ($settings.contentInteractions) {
        hookMarkdownLinkMouseEventHandlers($app, $plugin, el, file.path, file.path);
      }
    } else {
      el.createEl("div", {
        text: "File is empty",
    ...
    if ($settings.openNoteLayout === "right") {
      if (mainEntry) {
        if (((_d = (_c = mainEntry[1]) === null || _c === void 0 ? void 0 : _c.children) === null || _d === void 0 ? void 0 : _d.length) > 1) {
          const newLeaf = $app.workspace.getLeaf(import_obsidian5.Keymap.isModEvent(evt));
  ...
  const updateTagColorIndicator = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (contentDiv && $settings.tagPositionForCardColor === "content") {
      ...
      if (!frontmatter || !frontmatter.tags)
        return;
      const tags2 = Array.isArray(frontmatter.tags) ? frontmatter.tags : [frontmatter.tags];
      for (const tagColor of $settings.tagColors) {
        const matchingTag = tags2.find((tag) => tag === tagColor.name);
        if (matchingTag) {
  ...
  function getFooterMetadata() {
    ...
    switch (metadataType) {
      case "fileName":
        return file.name;
      case "folderName":
        return ((_a = file.parent) === null || _a === void 0 ? void 0 : _a.path) !== "/" ? ((_b = file.parent) === null || _b === void 0 ? void 0 : _b.path) || "" : "Root folder";
      case "editedTime":
...
function create_each_block_2(ctx) {
  ...
  return {
    c() {
      button = element("button");
      t = text(t_value);
      attr(button, "class", "action-bar__tag");
    },
    m(target, anchor) {
      insert(target, button, anchor);
      append(button, t);
...
function create_fragment2(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "action-bar__search");
      attr(button1, "class", "clickable-icon sort-button");
      attr(div1, "class", "search-component");
      attr(div2, "class", "action-bar__tags__list");
      attr(div3, "class", "action-bar__tags");
      attr(div4, "class", "action-bar");
      attr(
        div5,
        "class",
        /*actionBarStyle*/
      ...
      button2.disabled = button2_disabled_value = /*currentPageLocal*/
      ctx[7] === 1;
      button3.disabled = button3_disabled_value = /*currentPageLocal*/
      ctx[7] === /*$totalPages*/
      ctx[10];
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          ...
          ctx[19].call(null, div0)),
          action_destroyer(sortIcon_action = /*sortIcon*/
          ctx[14].call(null, button1)),
          listen(
            button1,
            "click",
            /*sortMenu*/
    ...
    p(ctx2, dirty) {
      ...
      8208) {
        ...
        group_outros();
        each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx2, each_value_1, each1_lookup, div6, outro_and_destroy_block, create_each_block_1, null, get_each_context_1);
        check_outros();
      }
      ...
      128 && button2_disabled_value !== (button2_disabled_value = /*currentPageLocal*/
      ctx2[7] === 1)) {
      ...
      1152 && button3_disabled_value !== (button3_disabled_value = /*currentPageLocal*/
      ctx2[7] === /*$totalPages*/
      ctx2[10])) {
...
function instance2($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, refreshOnResize, ($$value) => $$invalidate(28, $refreshOnResize = $$value));
  component_subscribe($$self, settings, ($$value) => $$invalidate(29, $settings = $$value));
  component_subscribe($$self, skipNextTransition, ($$value) => $$invalidate(30, $skipNextTransition = $$value));
  component_subscribe($$self, viewIsVisible, ($$value) => $$invalidate(31, $viewIsVisible = $$value));
  component_subscribe($$self, sort2, ($$value) => $$invalidate(32, $sort = $$value));
  component_subscribe($$self, allAllowedFiles, ($$value) => $$invalidate(33, $allAllowedFiles = $$value));
  component_subscribe($$self, plugin, ($$value) => $$invalidate(34, $plugin = $$value));
  component_subscribe($$self, searchQuery, ($$value) => $$invalidate(9, $searchQuery = $$value));
  component_subscribe($$self, refreshSignal, ($$value) => $$invalidate(35, $refreshSignal = $$value));
  component_subscribe($$self, totalPages, ($$value) => $$invalidate(10, $totalPages = $$value));
  component_subscribe($$self, currentPage, ($$value) => $$invalidate(22, $currentPage = $$value));
  component_subscribe($$self, tags, ($$value) => $$invalidate(11, $tags = $$value));
  component_subscribe($$self, folderName, ($$value) => $$invalidate(12, $folderName = $$value));
  component_subscribe($$self, displayedFiles, ($$value) => $$invalidate(13, $displayedFiles = $$value));
  let { cardsContainer } = $$props;
  let notesGrid;
  let viewContent;
  let columns;
  const sortIcon = (element2) => {
    (0, import_obsidian6.setIcon)(element2, "arrow-down-wide-narrow");
  };
  const refreshIcon = (element2) => {
    (0, import_obsidian6.setIcon)(element2, "refresh-ccw");
  };
  const closeIcon = (element2) => {
    (0, import_obsidian6.setIcon)(element2, "x");
  };
  ...
  function refreshView() {
    store_default.refreshSignal.set(!$refreshSignal);
    store_default.files.set($allAllowedFiles);
  }
  const searchInput = (element2) => {
    const searchInput2 = new import_obsidian6.SearchComponent(element2);
  ...
  function sortMenu(event) {
    const sortMenu2 = new import_obsidian6.Menu();
    ...
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Title (A-Z)" /* NameAsc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Title (A-Z)" /* NameAsc */, $settings);
    ...
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Title (Z-A)" /* NameDesc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Title (Z-A)" /* NameDesc */, $settings);
        yield $plugin.saveSettings();
      }));
    });
    ...
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Edited (newest first)" /* EditedDesc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Edited (newest first)" /* EditedDesc */, $settings);
        yield $plugin.saveSettings();
      }));
    });
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Edited (oldest first)" /* EditedAsc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Edited (oldest first)" /* EditedAsc */, $settings);
        yield $plugin.saveSettings();
      }));
    });
    sortMenu2.addSeparator();
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Created (newest first)" /* CreatedDesc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Created (newest first)" /* CreatedDesc */, $settings);
        yield $plugin.saveSettings();
      }));
    });
    sortMenu2.addItem((item) => {
      ...
      item.onClick(() => __awaiter(this, void 0, void 0, function* () {
        set_store_value(sort2, $sort = "Created (oldest first)" /* CreatedAsc */, $sort);
        set_store_value(settings, $settings.defaultSort = "Created (oldest first)" /* CreatedAsc */, $settings);
        yield $plugin.saveSettings();
      }));
    });
    sortMenu2.addSeparator();
  ...
  onMount(() => {
    set_store_value(sort2, $sort = $settings.defaultSort, $sort);
    $$invalidate(6, columns = Math.floor(viewContent.clientWidth / $settings.minCardWidth) + 1);
    $$invalidate(4, notesGrid = new MiniMasonry({
  ...
  afterUpdate((0, import_obsidian6.debounce)(() => __awaiter(void 0, void 0, void 0, function* () {
    if (!$viewIsVisible) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*$currentPage*/
    4194304) {
      $:
        $$invalidate(7, currentPageLocal = $currentPage);
    }
    if ($$self.$$.dirty[0] & /*$showActionBar*/
    8) {
      $:
        $$invalidate(8, actionBarStyle = $showActionBar ? "action-bar-parent" : "action-bar-parent action-bar-parent-hide");
    }
  };
  return [
    cardsContainer,
...
var NotesExplorerView = class extends import_obsidian7.ItemView {
  ...
  getAllFiles() {
    const onlyFolder = get_store_value(folderName);
    if (onlyFolder !== "") {
      return;
    } else {
  ...
  renderMoreOnScroll() {
    store_default.pagesView.set(this.settings.pagesView);
    ...
    if (!this.settings.pagesView) {
      ...
      if (pageBarContainer) {
        ...
        (0, import_obsidian7.setIcon)(leftArrowButton, leftSideArrow);
        ...
        store_default.currentPage.subscribe(() => {
          statusBarText.textContent = "Page : " + get_store_value(currentPage);
        });
        ...
        (0, import_obsidian7.setIcon)(rightArrowButton, rightSideArrow);
...
// main.ts
var NotesExplorerPlugin3 = class extends import_obsidian8.Plugin {
  constructor() {
    super(...arguments);
  ...
  async registerPluginEvents() {
    ...
    if (this.settings.openViewOnFolderClick) {
      this.registerDomEvent(document, "click", async (evt) => {
        ...
        if (Tfolder && Tfolder instanceof import_obsidian8.TFolder) {
  ...
  async openAllFilesInFolder(folder) {
    if (folder instanceof import_obsidian8.TFolder) {
      ...
      if (this.settings.showSubFolders) {
        ...
        files2 = folder.children.filter(
          (child) => child instanceof import_obsidian8.TFile && child.extension === "md"
        );
      }
      store_default.files.set(files2);
      store_default.folderName.set(folder.name);
    }
